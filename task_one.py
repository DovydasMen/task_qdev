...
class ParagraphHandler:
    ...
    @staticmethod
    def print_three_most_used_words(unique_words_count: Dict[str, int]) -> None:
    ...
    def print_shortest_sentence_and_words_count(
        ...
        print(
            f"\nThis is the shortest sentence:{sentence}. It has {min_words_count} words."
        )
    ...
    @staticmethod
    def print_paragraph_with_every_secound_letter_captalized(paragraph: str) -> None:
...
if __name__ == "__main__":
    ...
    print(
        f"Here are listed all words with count in paragraph:\n {words_counter}\n"
    )
    print("The top three most used words are:")
    paragraph_handler.print_three_most_used_words(words_counter)
    ...
    paragraph_handler.print_shortest_sentence_and_words_count(sentences_information)
    print("\nHere is the paragraph in which the first and every other letter from every word is capitalized:")
    paragraph_handler.print_paragraph_with_every_secound_letter_captalized("The European languages are members of the same family. Their separate existence is a myth. For science, music, sport, etc, Europe uses the same vocabulary. The languages only differ in their grammar, their pronunciation and their most common words. Everyone realizes why a new common language would be desirable: one could refuse to pay expensive translators. To achieve this, it would be necessary to have uniform grammar, pronunciation and more common words. If several languages coalesce, the grammar of the resulting language is more simple and regular than that of the individual languages. The new common language will be more simple and regular than the existing European languages. It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is.")
    print("\nHere is a version of the paragraph in which all words are in reversed order:")
    paragraph_handler.print_reversed_paragraph("The European languages are members of the same family. Their separate existence is a myth. For science, music, sport, etc, Europe uses the same vocabulary. The languages only differ in their grammar, their pronunciation and their most common words. Everyone realizes why a new common language would be desirable: one could refuse to pay expensive translators. To achieve this, it would be necessary to have uniform grammar, pronunciation and more common words. If several languages coalesce, the grammar of the resulting language is more simple and regular than that of the individual languages. The new common language will be more simple and regular than the existing European languages. It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is.")
